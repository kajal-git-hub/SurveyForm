...
class EditFormDataActivity : AppCompatActivity() {
    ...
    private lateinit var txtTitleForm:TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        txtTitleName = findViewById(R.id.txtTitleName_User)
        txtTitleForm = findViewById(R.id.txtTitleName_Home)
        ...
        txtTitleName.text = userName + " ( Ver.$versionName )"
        Log.e("getfprm",getPrefStringData(this, "currentForm").toString())
        txtTitleForm.text = getPrefStringData(this, "currentForm")
