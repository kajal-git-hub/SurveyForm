...
class EditTabFragment : Fragment(), OnTabChangedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        regular = ResourcesCompat.getFont(requireContext(), R.font.robotoregular)
        ...
        for (j in 0 until childrenArray.length()) {
            ...
            when (childObject.getString("type")) {
                ...
                "NUMBERS" -> {
                    ...
                    var value: String = ""
                    if (childObject.has("value")) {
                        if (childObject.has("value").toString().isNullOrBlank()) {
...
//                    var tvId=generateViewId("label_$childId")
                    ...
                    if (optionsList != null) {
                        ...
                        radioButton(optionsList, rg, tableName, childId, skipLogic, tvRadio, value,
                            autoPopulateId, linearLayout = linearLayout)
                    }
...
//                    addableDataArr.clear()
                    ...
                    if (childObject.has("relativeOptionsLogic")) {
                        ...
                        relativeOptionsLogic = childObject.getString("relativeOptionsLogic")
                        val relativeView = linearLayoutSection.findViewWithTag<EditText>("placeholder_$relativeOptionsLogic")
                        relativeView.addTextChangedListener(object : TextWatcher {
                            override fun afterTextChanged(s: Editable?) {
                                for (i in 0..s.toString().toInt() - 1) {
                                    addableRelative(
                   ...
                   /* var relativeOptionsLogic = ""
                    ...
                    if (childObject.has("value") && !childObject.get("value").toString()
                            .isNullOrBlank()
                                ...
                                Log.d(TAG, "displaySectionData 1: $relativeOptionsLogic")
...
//                            valueJSONArray = childObject.getJSONArray("value")
                                    ...
                                    Log.d(TAG, "displaySectionData 2: $relativeOptionsLogic")
                                    var valueJSONArrayRelative: JSONArray? = null
                                    if (childObject.has("value") && !childObject.get("value").toString()
                                            .isNullOrBlank()
                                    ) {

                                        Log.d(TAG, "displaySectionData 1: $sectionPos + ${childObject.get("value").toString()}")
                                        valueJSONArrayRelative = childObject.getJSONArray("value")
                                        for (i in 0 until valueJSONArrayRelative.length()) {
                                            val value = valueJSONArrayRelative.getJSONObject(i)
                                            addableRelative(
                                    ...
                                    Log.d(TAG, "displaySectionData 2: $sectionPos + ${childObject.get("value")?: ""}")
                                    val relativeView =
                                        linearLayoutSection.findViewWithTag<EditText>("placeholder_$relativeOptionsLogic")
                                    relativeView.addTextChangedListener(object : TextWatcher {
                                        override fun beforeTextChanged(
                                        ...
                                        override fun afterTextChanged(s: Editable?) {
                                            ...
                                            Log.d(TAG, "displaySectionData 3: $sectionPos + ${childObject.get("value")?: ""}")
                                            Log.d(TAG, "afterTextChanged 1: ${s.toString()}")
                                            for (i in 0..s.toString().toInt() - 1) {
                        ...
                        Log.d(TAG, "displaySectionData: else $sectionPos")
                        if (relativeOptionsLogic == "") {
                            addable(
                                childObject,
                                bt,
...
//                                                if (!addableFlag) {
    ...
    private fun addableUploadImage(
        ...
        layoutParamsTV.setMargins(25, 0, 25, 0)
        ...
        // save the addable imgevalue
        var newImageAdd: Uri? = null
        var oldImageAdd: Uri? = null
        var base64Encoded:String? = null
        addableActivityResultLauncher = registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
            if (result.resultCode == Activity.RESULT_OK) {
                val data: Intent? = result.data
                var imgUri2: Uri? = null
                if (data != null) {
                    ...
                    if (oldImageAdd != null) {
                      ...
                      base64Encoded = getPathFromUri(requireContext(), newImageAdd!!)
                    Log.e("adding value",base64Encoded.toString())

                    Log.e("uploaddAdd $k","$dynamicObject.toString() : $addableDataArr")
                    val jsonArray = JSONArray()
                    ...
                    Log.e("selectedURID",selectedImageUri.toString())
        ...
        if (value != "" && value != "NULL") {
            if (isJsonArray(value)) {
                ...
                Log.d(TAG, "uploadImage json: $valueArray")
...
//                saveValueAny(id, addableDataArr)
                ...
                Log.d(TAG, "inputTextAddable 2: $addableDataArr")
                if (addableDataArr != null) {
                    saveValueAny(id, addableDataArr)
                }

                Log.d(TAG, "inputTextAddable 3: $addableDataArr")
            }
...
//        linearLayoutAddableMain.removeView(btn)
    ...
    private fun dropDown(
        ...
        linearLayout.addView(tvDropDown, layoutParamsTV)
